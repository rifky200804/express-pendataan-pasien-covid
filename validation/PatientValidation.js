...
PatientValidation.createValidation = [
  ...
  body('status').notEmpty().withMessage('Status is required').isIn(['sembuh', 'positif', 'meninggal']).withMessage('Invalid status'),
...
PatientValidation.updateValidation = [
  ...
  body('phone').optional().isMobilePhone().withMessage('Invalid phone number'),
  body('address').optional().notEmpty().withMessage('Address is required'),
  body('status').optional().notEmpty().withMessage('Status is required').isIn(['sembuh', 'positif', 'meninggal']).withMessage('Invalid status'),
